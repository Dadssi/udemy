        ...
        <div x-data="{ email: '', password: '', name: '' }" 
            ...
            <form class="space-y-6" action="process-login.php" method="POST">
                ...
                <div class="input-field relative">
                    ...
                    <select x-model="email" type="email" id="email" name="email" required class="w-full px-4 py-3 rounded-lg bg-white bg-opacity-20 focus:bg-opacity-30 focus:ring-2 focus:ring-purple-300 text-white placeholder-gray-200 transition duration-200" placeholder="Email">
                    ...
                    <!-- <i class="fas fa-user-tag absolute right-3 top-3 text-secondary"></i> -->
                </div>
                <div class="input-field relative">
                    <label for="first-name"></label>
