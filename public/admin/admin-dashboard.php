                    ...
                    <div class="mt-8">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="w-1/5 px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Informatique</td>
                                    <td class="px-6 py-4 text-sm text-gray-500">Tout ce qui concerne les ordinateurs et les logiciels.</td>
                                </tr>
